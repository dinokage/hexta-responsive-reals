...
export const metadata = {
  ...
  description:
    "Learn more about HextaSphere, our mission, values, and the team behind our innovative IT and Engineering solutions.",
};
...
export default function AboutPage() {
  ...
  return (
    <>
      {/* About Hero */}
      <section className="relative pt-32 pb-16 dark:bg-[#1E1E1E] bg-[#F4F4F4]">
      ...
      {/* Mission and Values */}
      <section className="py-16 bg-[#F4F4F4] dark:bg-[#262626]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-dark max-w-3xl mx-auto">
              At HextaSphere, we&apos;re driven by a clear purpose and guided by
              strong values that shape our approach to every project and client
              relationship.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            {/* Mission */}
            <Card className="mb-4">
              <MagicCard className="p-1 rounded-lg">
                <CardHeader>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <CardContent>
                    <div className="p-2 rounded-lg">
                      <p className="text-dark text-sm">
                        ...
                        to deliver creative solutions that address evolving
                        business needs.
                      </p>
                    </div>
                  </CardContent>
                ...
                <MagicCard className="p-1 rounded-lg">
                  ...
                  <CardContent>
                    <div className="p-2 rounded-lg mb-4">
                      <p className="text-dark text-sm">
                        We maintain deep technical knowledge and industry
                        insights to provide informed guidance and superior
                        solutions.
                      </p>
                    </div>
                  </CardContent>
                ...
                <MagicCard className="p-1 rounded-lg">
                  <CardHeader>
                    ...
                    <CardContent>
                      <div className="p-2 rounded-lg">
                        <p className="text-dark text-sm">
                        We deliver reliable solutions with consistent communication, ensuring accountability throughout every project.
                        </p>
                      </div>
                    </CardContent>
                  </CardHeader>
              ...
              <div className="p-2 rounded-lg  ">
                <p className="text-dark text-sm">
                  We work closely with our clients, fostering partnerships built
              ...
              <MagicCard className="p-1 rounded-lg">
                ...
                and their achievement of business objectives.
                </p>
              </div>
                </CardContent>
              </MagicCard>
