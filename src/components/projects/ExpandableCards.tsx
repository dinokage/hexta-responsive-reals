      ...
      <ul className="mx-auto w-full gap-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 m-4 flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-[#BED8EF] to-[#FFF1C9] dark:dark:bg-gradient-to-r dark:from-[#1E3A5F] dark:to-[#4B3F2F]
...
const cards = [
  ...
  {
    description: "AwWwS",
    title: "Component Tag Extraction with OCR",
